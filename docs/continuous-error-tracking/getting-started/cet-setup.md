...
A Harness Monitored Service is a combination of service and environment. For Continuous Error Tracking, Harness monitors the following via a monitored service:
